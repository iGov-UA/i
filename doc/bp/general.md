...
```
**решение**: Синтаксические ошибки, необходимо проверить в валидаторе ошибок  XML-файлов. Пример: не закрыты кавычки, тэги, скобки в коде( ">" or "/>) не указан type и т.д

...
angular.module('about').controller('aboutController', function ($scope, SponsorsList) {
  ...
  $scope.aSponsors = SponsorsList.getAll();
  angular.forEach($scope.aSponsors, function (item) {
    item.height = 40;
  });

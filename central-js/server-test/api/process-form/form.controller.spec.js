...
var should = require('should')
  ...
  , bankidData = require('../../auth/bankid/bankid.data.spec.js')
  , bankidUtil = require('../../../server/auth/bankid/bankid.util.js')
  , testRequest = appTest.testRequest;

require('../../auth/bankid/bankid.nock.js');
require('../../auth/bankid-nbu/bankid.nock.js');
require('../subject/subject.service.nock.js');
require('../uploadfile/upload.nock.js');
require('./form.service.nock.js');

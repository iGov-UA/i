 ...
 */
public class ManagerLiqpay {

    private static final Logger LOG = LoggerFactory.getLogger(ManagerLiqpay.class);
    ...
    public void setPaymentStatus(String sID_Order, String sData, String sID_PaymentSystem, String sPrefix)
        ...
        try {
            ...
            LOG.error("Error: {}, incorrect sID_Order! can't invoke task_id:{}", oException.getMessage(), sID_Order);
        }
        ...
        if (sData != null) {
            try {			
                ...
                LOG.error("Error: {}, can't parse json!", oException.getMessage());
        ...
        if (nID_Task == null) {
            LOG.error("incorrect primary input data(BREAKED): (snID_Task={}, sID_Transaction={}, sStatus_Payment={})",
                    snID_Task, sID_Transaction, sStatus_Payment);
            //return;			
    ...
    public void setPaymentTransaction_ToActiviti(String snID_Task, String sID_Transaction, String sStatus_Payment,
        ...
        try {
            ...
            LOG.error("Error: {}, during changing: (snID_Task={}, sID_Transaction={}, sStatus_Payment={})", oException.getMessage(), snID_Task, sID_Transaction, sStatus_Payment);
            throw oException;
        }
    }    
}

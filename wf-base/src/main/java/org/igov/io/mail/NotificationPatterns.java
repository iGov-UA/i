      ...
      */
        try {
            ...
            String sBody = String.format("Ваша заявка %s прийнята!", sID_Order) +
                    ...
                    + "\">\"Мій журнал\"</a>. Також на кожному етапі Ви будете отримувати email-повідомлення." + "<br>У разі необхідності Ви можете спрямувати питання та пропозиції до <a href=\"https://docs.google.com/spreadsheets/d/15w9ui-Mz8fTWDHHpDNx52Fnn3lknKsyh68tsX5znKtY/edit#gid=1246904557\" target=\"_blank\">групи підтримки iGov</a> у Вашій області";

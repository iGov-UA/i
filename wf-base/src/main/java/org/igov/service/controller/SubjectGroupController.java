...
import org.igov.service.business.subject.SubjectGroupsVO;
...
public class SubjectGroupController {
    ...
    @ResponseBody
    public List<SubjectGroupsVO> getSubjectGroups(@ApiParam(value = "ид группы", required = true) @RequestParam(value = "sID_Group_Activiti") String sID_Group_Activiti,
    		 @ApiParam(value = "глубина выборки", required = false) @RequestParam(value = "nDeepLevel", required = false) Long nDeepLevel)
            throws Exception  {
    	List<SubjectGroupsVO> subjectGroupResult = null;
    	try {

...
public interface ConstantsInterceptor {
	...
	static final String SERVICE_FORM_FORM_DATA = "/service/form/form-data";
        static final String SERVICE_CANCELTASK = "/service/action/task/cancelTaskNew";
	...
	static final String SERVICE_SUBJECT_PROCESS_SET_PROCESS_SUBJECT_STATUS = "/service/subject/process/setProcessSubjectStatus";

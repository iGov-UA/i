 ...
 */
@Service
public class MailTaskWithAttachmentsAndSMSService extends Abstract_MailTaskCustom {

    private final static Logger LOG = LoggerFactory.getLogger(MailTaskWithAttachmentsAndSMSService.class);

    private Expression saAttachmentsForSend;
    protected Expression sPhone_SMS;
    protected Expression sText_SMS;

    public void MailTaskWithAttachmentsAndSMS(DelegateExecution oExecution) throws Exception {

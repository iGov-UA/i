 ...
 *
 */
@Component("Update_ARM_OLD")
public class Update_ARM_old extends Abstract_MailTaskCustom implements JavaDelegate {

	private final static Logger LOG = LoggerFactory.getLogger(Update_ARM_old.class);

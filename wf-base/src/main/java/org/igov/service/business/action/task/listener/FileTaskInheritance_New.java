 ...
 * @author askosyr
 */
@Component("fileTaskInheritance_New")
public class FileTaskInheritance_New extends AbstractModelTask implements TaskListener {

    private static final long serialVersionUID = 1L;

    private static final transient Logger LOG = LoggerFactory.getLogger(FileTaskInheritance_New.class);

...
public class ActionExecuteOldServiceImpl implements ActionExecuteOldService {
    ...
    public Long setActionExecuteOld(Long nID_ActionExecuteStatus,
        ...
        session.saveOrUpdate(actionExecuteOld);

        return actionExecuteOld.getId();
    }


    public List<ActionExecuteOld> getActionExecuteOldListByCriteria(Integer nRowsMax, String sMethodMask, String asID_Status, Integer nTryMax, Long nID, Session session) {

        ...
        try {
            ...
            if (sPhone_SMS_Value != null) {
                ...
                if (sText_SMS_Value != null) {
                    ...
                    sReturn = ManagerSMS.sendSms(generalConfig.getOrderId_ByOrder(getProtectedNumber(Long.valueOf(oExecution.getProcessInstanceId()))),
                            sPhone_SMS_Value, sText_SMS_Value, true);

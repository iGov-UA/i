...
public enum HistoryEventType {
    ...
    TASK_REQUEST_NOT_ACTUAL(22L,
            ...
            "%ПІБ виконавця (логін виконавця)% - завдання не актуальне"),

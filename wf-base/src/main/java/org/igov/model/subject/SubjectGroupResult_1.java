...
public class SubjectGroupResult_1 implements IVisitable {
	
	private static final Log LOG = LogFactory.getLog(SubjectGroupResult_1.class);
	...
	public SubjectGroupResult_1(String nameGroupActiviti) {

...
public class MailTaskWithAttachment extends Abstract_MailTaskCustom {
    ...
    private final static Logger oLog = LoggerFactory.getLogger(MailTaskWithAttachment.class);
    ...
    public void execute(DelegateExecution oExecution) throws Exception {
        ...
        oLog.info("sAttachName= " + sAttachName);
        if (aAttachment != null && !aAttachment.isEmpty()) {
            ...
            oLog.info("sFileExt= " + sFileExt);
            oLog.info("sFileExtNew= " + sFileExtNew);

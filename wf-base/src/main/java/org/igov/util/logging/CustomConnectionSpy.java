...
/**
 * Connection wrapper to log insert, update and delete sql statements.
 *
 * User: goodg_000
 * Date: 29.05.2016
 * Time: 17:06
 */
public class CustomConnectionSpy implements Connection {
    private final static List<String> SQL_KEYWORDS = Arrays.asList("insert", "update", "delete");

    private Connection realConnection;
    private ConnectionSpy connectionSpy;

    public CustomConnectionSpy(Connection realConnection) {
        this.realConnection = realConnection;
        this.connectionSpy = new ConnectionSpy(realConnection);
    }
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException
    {
        ...
        return wrapInSpy(sql, statement);
    }

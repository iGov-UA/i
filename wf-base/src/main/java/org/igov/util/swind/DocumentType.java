...
public class DocumentType implements java.io.Serializable {
    ...
    public static final DocumentType Original = new DocumentType(_Original);
    public static final DocumentType Response = new DocumentType(_Response);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://swined/", "DocumentType"));
    }
    /**

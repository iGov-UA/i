...
/**
 * <p>Java class for DGI4lzColumn complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="DGI4lzColumn">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;>DGI4lz">
...
@XmlType(name = "DGI4lzColumn", propOrder = {
    "value"
})
public class DGI4LzColumn {
    ...
    /**
     * 
     * 			Число 4 знаки з початковими нулями від 0000 до 9999
     * 		 	використовується для: 
     * 		 	 * код умовного позначення одиниць виміру ПН
     * 			
     * 
     * @return
     *     possible object is

...
public class DemoDataConfiguration {
    ...
    protected static final Logger oLog = LoggerFactory.getLogger(DemoDataConfiguration.class);
    ...
    protected void initDemoUsers() {
        createUser("kermit", "Kermit", "The Frog", "kermit", "kermit@activiti.org",
                ...
                Arrays.asList("management", "sales", "marketing", "engineering", "management_clerk_dmr", "user",
                        "admin"),
    ...
    protected void generateReportData() {
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                oLog.info("Demo report data generated");
            }
    ...
    protected void createModelData(String name, String description, String jsonFile) {
        ...
        if (modelList == null || modelList.isEmpty()) {
            ...
            try {
                ...
                oLog.warn("Failed to read SVG", e);
            }
            ...
            try {
                ...
                oLog.warn("Failed to read editor JSON", e);
            }
        }
    }

...
public class ActivitiRestApiController extends ExecutionBaseResource {
	...
	@Transactional
	public @ResponseBody String putAttachmentsToRedis(
	...
	@Transactional
	public @ResponseBody byte[] getAttachmentsFromRedis(
	...
	@Transactional
	public @ResponseBody byte[] getAttachmentsFromRedisBytes(
			@RequestParam("key") String key) throws ActivitiIOException {
		byte[] upload = null;
		try {
	...
	@Transactional
	public @ResponseBody String checkAttachmentsFromRedisSign(
	...
	@Transactional
	public @ResponseBody byte[] getAttachmentFromDb(
	...
	@Transactional
	public @ResponseBody String checkAttachSign(
	...
	@Transactional
	public @ResponseBody byte[] getAttachmentFromDbExecution(
	...
	@Transactional
	public @ResponseBody AttachmentEntityI putAttachmentsToExecution(
			@RequestParam(value = "taskId") String taskId,
	...
	@Transactional
	public @ResponseBody AttachmentEntityI putTextAttachmentsToExecution(
	 ...
	 *             <p/>
	 *             example:
	 *             https://test.region.igov.org.ua/wf/service/rest/file/
	 *             downloadTasksData
	...
	public @ResponseBody void setTaskAnswer(
			@RequestParam(value = "sID_Order", required = false) String sID_Order,
			@RequestParam(value = "nID_Protected", required = false) Long nID_Protected,
			@RequestParam(value = "nID_Process", required = false) Long nID_Process,
			@RequestParam(value = "nID_Server", required = false) Integer nID_Server,

...
update_act_hi_comment;pdate "public"."act_hi_comment" d set "proc_inst_id_" = '0' from "public"."act_hi_procinst" p where p."proc_def_id_" like '%s%' and p."proc_inst_id_" = d."proc_inst_id_"
delete_act_hi_comment;elete from "public"."act_hi_comment" d where "proc_inst_id_" = '0'
...
delete_act_hi_procinst;elete from "public"."act_hi_procinst" where "proc_def_id_" like '%s%'   
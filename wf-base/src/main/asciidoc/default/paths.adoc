...
|QueryParameter|sLogin|Логин подписанта|false|string|
|QueryParameter|sKey_Step|Ключ шага документа|false|string|
|BodyParameter|aContent|aContent|false|string array|
|BodyParameter|saAttribute|saAttribute|false|<<Map«string,object»>> array|
|BodyParameter|bSetVariable|bSetVariable|false|boolean|
|===

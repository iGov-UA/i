...
==== setAttachment
----
POST /object/file/setAttachment
----
...
|===
|Type|Name|Description|Required|Schema|Default
|QueryParameter|nID_Process|номер-ИД процесса|true|string|
|QueryParameter|bSigned|наложено или не наложено ЭЦП|false|boolean|
|QueryParameter|sID_StorageType|cтрока-ИД типа хранилища Redis или Mongo|false|boolean|
|QueryParameter|nID_Process|массив атрибутов в виде сериализованного обьекта JSON|true|string|
|FormDataParameter|oFile|файл для сохранения в БД|false|file|
|QueryParameter|sFileNameAndExt|название и расширение файла|true|string|
|QueryParameter|sID_Field|если не null - удаляем аттач перед записью|false|string|
|QueryParameter|sContentType|строка-MIME тип отправляемого файла (по умолчанию = "text/html")|false|string|
|BodyParameter|sData|sData|true|string|
|===

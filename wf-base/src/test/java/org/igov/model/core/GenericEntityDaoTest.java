...
@ContextConfiguration("/org/igov/model/testContext.xml")
@TestExecutionListeners({ DependencyInjectionTestExecutionListener.class, DbUnitTestExecutionListener.class })
@DatabaseSetup("/org/igov/model/dataset.xml")
public class GenericEntityDaoTest {
    ...
    @Test
    @ExpectedDatabase("/org/igov/model/shouldUpdateJediName-dataset.xml")
    ...
    @Test
    @DatabaseSetup("/org/igov/model/shouldSaveJedi-setup.xml")
    @ExpectedDatabase("/org/igov/model/shouldSaveJedi-dataset.xml")
    ...
    @Test
    @ExpectedDatabase("/org/igov/model/shouldUpdate2Jedi-dataset.xml")
    ...
    @Test
    @DatabaseSetup("/org/igov/model/shouldSave2Jedi-setup.xml")
    @ExpectedDatabase("/org/igov/model/shouldSave2Jedi-dataset.xml")
    ...
    @Test
    @ExpectedDatabase("/org/igov/model/shouldDeleteJediById-dataset.xml")
    ...
    @Test
    @ExpectedDatabase("/org/igov/model/shouldDeleteByWeaponName-dataset.xml")
    ...
    @Test
    @ExpectedDatabase("/org/igov/model/shouldDelete2JediById-dataset.xml")
    ...
    @Test
    @ExpectedDatabase("/org/igov/model/shouldDeleteAllJedi-dataset.xml")

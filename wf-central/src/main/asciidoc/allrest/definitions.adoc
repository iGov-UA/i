...
|Name|Description|Required|Schema|Default
|answer||false|string|
|dateAnswerExpire||false|<<DateTime>>|
|dateCreate||false|<<DateTime>>|
|fio||false|string|
|id_Document||false|integer (int64)|
|mail||false|string|
|ms||false|integer (int64)|
|nID||false|integer (int64)|
|sCode||false|string|
|sCodeType||false|string|
|sDateAnswerExpire||false|<<DateTime>>|
|sDateCreate||false|<<DateTime>>|
|secret||false|string|
|target||false|string|
|telephone||false|string|
|===
...
|nTimeHours||false|integer (int32)|
|sBody||false|string|
|sDate||false|<<DateTime>>|
|sHead||false|string|
|sID||false|string|

...
|===
|Type|Name|Description|Required|Schema|Default
|QueryParameter|nID_SlotHold|ИД слота резервации|false|string|
|===
...
|QueryParameter|snID_Task_Activiti|Ид таски|true|string|
|QueryParameter|sLoginController|Логин контролирующего|true|string|
|QueryParameter|sLoginExecutor|Логин исполнителя|true|string|

...
|QueryParameter|sLogin|sLogin|false|string|
|QueryParameter|sID_BP|sID_BP|true|string|
|QueryParameter|nID_Subject|nID_Subject|true|string|
|QueryParameter|nID_Service|nID_Service|true|string|
|QueryParameter|nID_ServiceData|nID_ServiceData|true|string|

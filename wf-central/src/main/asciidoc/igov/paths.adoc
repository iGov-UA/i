...
|QueryParameter|snID_Task_Activiti|Ид таски|true|string|
|QueryParameter|sLoginMain|Логин того, кто вызвал сервис|true|string|
|QueryParameter|sLoginSecondary|Логин исполнителя, нужен в некоторых кейсах, когда сервис вызывает контролирующий|false|string|

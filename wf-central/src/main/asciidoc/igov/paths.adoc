...
=== ActionEscalationController — Действия Эскалаций
:hardbreaks:
...
----
GET /object/place/getOrderPlaces
----
...
==== Отправить отзыв по услуге от сторонней организации
----
...
|QueryParameter|nID_Rate|ID оценки|true|integer (int64)|
|QueryParameter|nID_Service|ID сервиса|true|integer (int64)|
|QueryParameter|sAnswer|комментарий для отзыва|false|string|
...
|QueryParameter|bAuth|булевский флаг, Включить авторизацию|false|boolean|
|QueryParameter|sID_File|строка-Ключ записи redis|false|string|
...
|QueryParameter|sID_DataLink|Ключ записи в Монго ДБ|false|string|
|===

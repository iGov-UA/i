...
==== Получение статистики по выбранному списку сервисов и региону за заданный промежуток времени
----
GET /action/event/getServicesStatisticOfDnepr
----
...
|QueryParameter|nID_Proccess_Escalation|номер-ид бп эсклации (поле на перспективу для следующего тз по эскалации)|false|integer (int64)|
|QueryParameter|nID_StatusType|числовой код, который соответсвует статусу|true|integer (int64)|
|QueryParameter|sID_Public_SubjectOrganJoin|значение органа, в котором заказана услуга|false|string|
|===
...
==== Получение списка email юзеров которые были выбраны в таблице
----
GET /action/identity/getUsersEmailFromTable
----
...
|QueryParameter|sID_Table|ид таблицы (переменная из БП)|true|string|
|QueryParameter|sID_FieldTable|ид столбца таблицы (с какого столбца вытянуть емайлы)|true|string|
|===
...
----
POST /action/task/setTaskAnswer_Central
----
...
|BodyParameter|sJson|JSON с параметрами: sBody - строка тела сообщения; saField - строка-массива полей (например: "[{'id':'sFamily','type':'string','value':'Белявцев'},{'id':'nAge','type':'long','value':35}]")|true|string|
|===
...
|===
|Type|Name|Description|Required|Schema|Default
|QueryParameter|nID_Order|номер заявки|true|string|
|===
...
=== ArmController — Трансфер Данных В Таблицу
:hardbreaks:
Arm Controller

==== Получение данных из таблицы arm.dbo.TK
----
GET /arm/getDboTkByOutNumber
----
...
|===
|Type|Name|Description|Required|Schema|Default
|QueryParameter|sID_Order|Номер заявки из айдок|true|string|
|===
...
==== Обновление данных таблицы arm.dbo.TK
----
POST /arm/createDboTk
----
...
|===
|Type|Name|Description|Required|Schema|Default
|BodyParameter|dboTkModel|Данные для добавление новой записи в таблицу arm.dbo.TK |true|<<DboTkModel>>|
|===
...
|===
|Type|Name|Description|Required|Schema|Default
|BodyParameter|dboTkModel|Данные для обновления данных в таблице arm.dbo.TK |true|<<DboTkModel>>|
|===
...
==== /getBase64MimeEncodedFile
----
POST /object/file/getBase64MimeEncodedFile
----
...
|===
|Type|Name|Description|Required|Schema|Default
|FormDataParameter|file|MultipartFile для кодирования в Base64 MIME|true|file|
|===
...
==== /getJsonBase64EncodedFiles
----
POST /object/file/getJsonBase64EncodedFiles
----
...
==== /getBase64DecodedFile
----
POST /object/file/getBase64DecodedFile
----
...
|===
|Type|Name|Description|Required|Schema|Default
|QueryParameter|isMime|использовать MIME декодер|false|boolean|
|FormDataParameter|file|MultipartFile для декодирования из Base64|true|file|
|BodyParameter|byteArray|byteArray|true|string array|
|===
...
----
POST /object/file/getBase64EncodedFile
----
...
|===
|Type|Name|Description|Required|Schema|Default
|FormDataParameter|file|MultipartFile для кодирования в Base64|true|file|
|===
...
|===
|Type|Name|Description|Required|Schema|Default
|QueryParameter|sID_ProcessSubjectStatus|Статус|true|string|
|QueryParameter|snID_Task_Activiti|Ид таски|true|string|
|QueryParameter|sLoginController|Логин контролирующего|false|string|
|QueryParameter|sLoginExecutor|Логин исполнителя|false|string|
|QueryParameter|sText|Текстовое поле|false|string|
|QueryParameter|sDatePlaneNew|Дата на которую нужно перенести срок|false|string|
|===
...
|QueryParameter|nID_SubjectContactType|тип контакта|true|integer (int64)|
|===
...
==== getSID_Auth_PB_SMS
----
GET /subject/message/getSID_Auth_PB_SMS
----

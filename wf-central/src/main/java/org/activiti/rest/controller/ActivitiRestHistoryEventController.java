...
public class ActivitiRestHistoryEventController {
    ...
    private static final String noteGetHistoryEvent_Service = noteController + "Получить объект события по услуге #####\n\n"
    ...
    private static final String noteAddHistoryEvent_Service = noteController + "Добавляет объект события по услуге #####\n\n"
    ...
    private static final String noteUpdateHistoryEvent_Service = noteController + "Обновить объект события по услуге #####\n\n"
    ...
    private static final String noteGetLastTaskHistory = noteController + "Проверка наличия task определенного Бизнес процесса (БП), указанного гражданина #####\n\n"
    ...
    private static final String noteGetHistoryEvent = noteController + "Работа с историей (Мой журнал). Получение документа по ид документа #####\n\n"
    ...
    private static final String noteGetHistoryEvents = noteController + "Работа с историей (Мой журнал). Загрузка событий #####\n\n"
		+ "HTTP Context: http://server:port/wf/service/services/getHistoryEvents\n\n"
		+ "- nID_Subject - ID авторизированого субъекта (добавляется в запрос автоматически после аутентификации пользователя)";

    private static final String noteGetStatisticServiceCounts = noteController + "Получение количества записей HistoryEvent_Service для сервиса по регионам #####\n\n"
    ...
    private static final String noteGetStartFormByTask = noteController + "Получение полей стартовой формы по: ИД субьекта, ИД услуги, ИД места Услуги #####\n\n"
    ...
    HistoryEvent_Service getLastTaskHistory(
	    ...
	    @ApiParam(value = "номер-ИД услугии", required = true) @RequestParam(value = "sID_UA", required = true) String sID_UA) throws ActivitiRestException {
    ...
    public
    @ResponseBody
    HistoryEvent getHistoryEvent( @ApiParam(value = "ИД-номер документа", required = true) @RequestParam(value = "nID") Long id) {
    ...
    public
    @ResponseBody
    String getStatisticServiceCounts( @ApiParam(value = "nID_Service ID сервиса", required = true) @RequestParam(value = "nID_Service") Long nID_Service) {
    ...
    String getStartFormByTask(
	    ...
	    @ApiParam(value = "строка-ИД места Услуги", required = true) @RequestParam(value = "sID_UA") String sID_UA) throws RecordNotFoundException {

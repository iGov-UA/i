...
import static org.igov.service.controller.SubjectMessageController.sMessageHead;
...
public class DebugCentralController {
    ...
    String setMessageRate(
        ...
        SubjectMessageController oSubjectMessageController = new SubjectMessageController();
        if(sID_Order==null){
        ...
        try {
            ...
            if(nRateWas!=null && nRateWas > 0){
                ...
                SubjectMessage oSubjectMessage_Rate
                        = oSubjectMessageController.createSubjectMessage(
